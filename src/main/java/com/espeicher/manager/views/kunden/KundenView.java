package com.espeicher.manager.views.kunden;
...
@PageTitle("Kunden")
@CssImport("styles/views/kunden/kunden-view.css")
public class KundenView extends Div {
    ...
    public KundenView(@Autowired PersonService personService) {
        setId("kunden-view");
        // Configure Grid
